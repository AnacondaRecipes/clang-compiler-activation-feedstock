...
FINAL_CXXFLAGS="-ftree-vectorize -fPIC -fstack-protector-strong -O2 -pipe -stdlib=libc++ -isysroot \$CONDA_BUILD_SYSROOT -I\$PREFIX/include/c++/v1 -fvisibility-inlines-hidden -fmessage-length=0"
